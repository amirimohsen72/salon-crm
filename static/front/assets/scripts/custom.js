...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaScope = "https://designesia.ir/html/templates/duo/";
    var pwaLocation = "https://designesia.ir/html/templates/duo/_service-worker.js";
    ...
    function init_template(){
        ...
        if(copyrightYear){
            copyrightYear.forEach(function(e){
                var dteNow = new Date().toLocaleString("fa-IR", { year: "numeric" });
                e.textContent = dteNow;
            });
        }
        ...
        if(!addOfflineClasses.length){
            ...
            offlineAlert.innerHTML = '<i class="bi bi-wifi-off ps-2"></i> اتصال اینترنت برقرار نیست';
            onlineAlert.className = 'online-message bg-green-dark shadow-bg shadow-bg-s color-white';
            onlineAlert.innerHTML = '<i class="bi bi-wifi ps-2"></i> اتصال اینترنت برقرار شد.';
